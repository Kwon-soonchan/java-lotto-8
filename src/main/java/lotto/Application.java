...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("3개 일치 (5,000원) - " + matching[0]);
        System.out.println("4개 일치 (50,000원) - " + matching[1]);
        System.out.println("5개 일치 (1,500,000원) - " + matching[2]);
        System.out.println("5개 일치, 보너스  볼 일치 (30,000,000원) - " + matching[3]);
        System.out.println("6개 일치 (2,000,000,000원) - " + matching[4]);
